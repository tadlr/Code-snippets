...
var media_xs_max = window.matchMedia("(max-width:" + screen_xs_max + ")").matches;
var media_sm_min = window.matchMedia("(min-width:" + screen_sm_min + ")").matches;
var media_sm_max = window.matchMedia("(max-width:" + screen_sm_max + ")").matches;
var media_md_min = window.matchMedia("(min-width:" + screen_md_min + ")").matches;
var media_md_max = window.matchMedia("(max-width:" + screen_md_max + ")").matches;
var media_lg_min = window.matchMedia("(min-width:" + screen_lg_min + ")").matches;
