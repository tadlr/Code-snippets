<?php
    // Src: https://stackoverflow.com/a/15306647
    require('../../../../../wp-load.php');
?>
<div class="modal-window fade_in">
    <div class="modal-wrapper"><h2>Steak House Restaurant</h2>
        ...
        <div class="modal-body">
            <div class="gallery">
                <div class="image">
                    ...
                    <div class="type"><i><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/restaurants-bars/restaurants/restaurant.png" alt=""></i><span>Apartment</span></div>
                    <div class="owl-carousel gallery">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/items/1.jpg">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/items/5.jpg">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/items/4.jpg">
                    </div>
                </div>
        ...
        <div class="modal-close"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/close.png"></div>
    </div>
