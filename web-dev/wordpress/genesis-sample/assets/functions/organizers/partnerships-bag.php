        ...
        if ( !empty ($user_query->get_results()) ){
            foreach ($user_query->get_results() as $user) { $member_ID = $user;
                //echo ($user.'<br/>');
                    ...
                    if (um_profile('business-address') != '' && um_user('Seeking') == 'Partnerships' && um_user('Focus') == "Bag")  {
            ...
            $fileLocation = getenv("DOCUMENT_ROOT") . "/wp-content/themes/genesis-sample/assets/json/organizers/organizer-partnerships-bag.json";
