...
$ResultadosFinales = '';            
        ...
        if ( !empty ($user_query->get_results()) ){
            foreach ($user_query->get_results() as $user) { $member_ID = $user;
                    ...
                    if (um_profile('Current-Address') != '' && um_user('Focus') == "Bottle") {
                    ...
                    $Field_location = '"location": "'.um_user('Current-Address').'",';
            ...
            if ($ResultadosFinales != '') {
                $fileLocation = getenv("DOCUMENT_ROOT") . "/wp-content/themes/genesis-sample/assets/json/student/student-bag.json";
