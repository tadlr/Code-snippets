...
// Set width for inputs in horizontal search bar -----------------------------------------------------------------------
    ...
    $( "#redefine-search-form" ).load( urlCompleta+"assets/external/_search-bar.html", function() {
        setInputsWidth();
        //autoComplete();
    });
...
function drawOwlCarousel(_rtl){
    $.getScript( urlCompleta+"assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
        ...
        if( category == 'real_estate' ){
            if( json.data[a].item_specific ){
                /*if( json.data[a].item_specific.bedrooms ){
                    itemSpecific += '<span title="Bedrooms"><img src="'+urlCompleta+'assets/img/bedrooms.png">' + json.data[a].item_specific.bedrooms + '</span>';
                }
                if( json.data[a].item_specific.bathrooms ){
                    itemSpecific += '<span title="Bathrooms"><img src="'+urlCompleta+'assets/img/bathrooms.png">' + json.data[a].item_specific.bathrooms + '</span>';
                }
                if( json.data[a].item_specific.area ){
                    itemSpecific += '<span title="Area"><img src="'+urlCompleta+'assets/img/area.png">' + json.data[a].item_specific.area + '<sup>2</sup></span>';
                }
                if( json.data[a].item_specific.garages ){
                    itemSpecific += '<span title="Garages"><img src="'+urlCompleta+'assets/img/garages.png">' + json.data[a].item_specific.garages + '</span>';
                } */
                return itemSpecific;
            }
        }
...
function quickView(id){
    $.ajax({
        type: 'POST',
        url: urlCompleta+'assets/external/_modal.php',
        data: id,
