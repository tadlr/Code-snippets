    ...
    visibleItemsArray.push(
        '<li>' +
            '<div class="item" id="' + json.data[a].id + '">' +
                '<a href="http://synchronizehub.com/profile/'+ json.data[a].id +'" class="image">' +
                    '<div class="inner">' +
                ...
                '</a>' +
                '<div class="wrapper">' +
                    '<a href="http://synchronizehub.com/profile/'+ json.data[a].id +'" id="' + json.data[a].id + '"><h3 class="ResultsName">' + '<i class="' + json.data[a].MapIcon + ' Titleicon"></i>' + json.data[a].title + '</h3></a>' +
