...
include ('./wp-content/themes/genesis-sample/assets/functions/students-load.php');
...
<div id="outer-wrapper">
    ...
    <div id="inner-wrapper">
        ...
        <!-- end Navigation-->
        <!-- Page Canvas-->
        <div id="page-canvas STUDENTPAGE">
            ...
            <div id="page-content">
                ...
                <div class="map-canvas list-solid">
                    ...
                    <div class="items-list">
                        <div class="inner">
                            <div id="StudentForm">
                                <?php include ('./wp-content/themes/genesis-sample/assets/elements/StudentSearch.php'); ?>
                            </div>
                            <!--end Filter--> 
                            <div class="MapResultsList STUDENTPAGE">
...
$('#Userlocation').autocomplete({
    source: function (request, response) {
        $.getJSON("/wp-content/themes/genesis-sample/assets/json/student-location.json?term=" + request.term, function (data) {
            response($.map(data.location, function (value, key) {
                return {
                    location: value,
                    placeid: key
                };
